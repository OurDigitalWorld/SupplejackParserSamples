class WPLparser2 < SupplejackCommon::Xml::Base
  ...
  attributes :display_content_partner, default: "West Vancouver Memorial Library"
  ...
  attributes :title, xpath: "//field[@name='title']"
    ...
    reject_if do
    get(:title).find_with(/Collection/).present?
end
