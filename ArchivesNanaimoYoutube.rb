class ArchivesNanaimoYoutube < SupplejackCommon::Json::Base
  
  #add your YouTube api key
    base_url "https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UCx4lkFax0RKmOFt9KwQck5A&key=YOUR-KEY-HERE&maxResults=50"
  ...
  #static attributes
  attribute :display_content_partner, default: "Archives Nanaimo"
